...
public class AppStart {
	...
	public static void main(String[] args) {
		...
		try {
			...
			List<Funcionario> updatedListFunc = Persiste.listar(Funcionario.class);
			...
			List<ChefeDeDepartamento> savedListChefe = Persiste.listar(ChefeDeDepartamento.class);
			...
			// Show it!
			System.out.println("Lista atualizada");
			List<ChefeDeDepartamento> updatedListChefe = Persiste.listar(ChefeDeDepartamento.class);
			...
			// Show it!
			System.out.println("Lista atualizada");
			List<PacienteDeClinica> updatedListPaci = Persiste.listar(PacienteDeClinica.class);
